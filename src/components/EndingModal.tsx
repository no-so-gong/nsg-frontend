...
export default function EndingModal({ visible, onClose }: SettingsModalProps) {
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              console.error('다시 시작 실패:', error);
              Alert.alert('다시 시작 실패', error.message || '게임 다시 시작 중 오류가 발생했습니다.');
            } finally {
        ...
        <View style={styles.container}>
          <View style={styles.innerContainer}>
            <View style={styles.boneWrapper}>
              <BoneLabelSvg label="다시 시작" />
            </View>

            <View style={styles.contentContainer}>
              <View style={styles.infoSection}>
                <Text style={styles.infoLabel}>게임을 다시 시작하시겠어요?</Text>
                <Text style={styles.infoLabel}>즐거웠던 시간을 뒤로하고, 아이들과의 첫 만남부터 다시 시작하게 돼요!</Text>
              </View>
